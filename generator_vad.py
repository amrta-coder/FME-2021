...
class FeatruesSequence(Sequence):
    ...
    def __init__(self, dataset_csv_file, batch_size=16, verbose=0, shuffle_on_epoch_end=True, random_state=1, test=False):
        """
    ...
    def prepare_dataset(self):
        ...
        self.x_path, self.y = df["file_path"].values, df["label"].values
