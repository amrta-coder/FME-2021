...
class ResnetBlock(Model):
    def __init__(self, n_filters, n_kernels, is_training=True):
...
class Resnet1D(Model):
    def __init__(self, params=None, is_training=True):
    ...
    def call(self, inputs_shape, training=None, mask=None, weights_path=None):
        signal_input = Input(shape=inputs_shape)
